...
function getDeploymentName() {
  ...
  if (hostname.startsWith("dep-")) {
    index = 1;
  }
  return hostname.split("-")[index];
}

function getNewRelicLicenseKey() {
...
exports.config = {
   ...
   */
  app_name: [getDeploymentName()],
  /**
   * Your New Relic license key.
   */
  license_key: getNewRelicLicenseKey(), // bb929f3d37bc30d1bfbbc7b98c318d9da7a4c6be',
  /**
   *
   ...
   */
  capture_params: false, // TODO: Remove this option in Agent v5.
  /**
