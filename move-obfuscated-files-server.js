...
function moveFiles(dir, old_path, new_path){
    try {
        ...
        // console.log("1. Static files removed from server build.");
    } catch (err) {
    ...
    fs_extra.move(old_path, new_path, err => {
        ...
        fs.rmdirSync("obfuscateserver", { recursive: true });
        console.log("4. Original obfuscated directory removed");
    });
}
moveFiles("server/build/src", "obfuscateserver/src", "server/build/src");
