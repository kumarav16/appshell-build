...
f)b(a[c],c)}var n=document.createElement("link"),x="import"in n,H=n.querySelectorAll("*"),z=null;!1==="currentScript"in document&&Object.defineProperty(document,"currentScript",{get:function(){return z||("complete"!==document.readyState?document.scripts[document.scripts.length-1]:null)},configurable:!0});var I=/(url\()([^)]*)(\))/g,J=/(@import[\s]+(?!url\())([^;]*)(;)/g,K=/(<link[^>]*)(rel=['|"]?stylesheet['|"]?[^>]*>)/g,l={v:function(a,b){a.href&&a.setAttribute("href",l.c(a.getAttribute("href"),
b));a.src&&a.setAttribute("src",l.c(a.getAttribute("src"),b));if("style"===a.localName){var c=l.s(a.textContent,b,I);a.textContent=l.s(c,b,J)}},s:function(a,b,c){return a.replace(c,function(d,f,e,g){d=e.replace(/["']/g,"");b&&(d=l.c(d,b));return f+"'"+d+"'"+g})},c:function(a,b){if(void 0===l.f){l.f=!1;try{var c=new URL("b","http://a");c.pathname="c%20d";l.f="http://a/c%20d"===c.href}catch(d){}}if(l.f)return(new URL(a,b)).href;c=l.u;c||(c=document.implementation.createHTMLDocument("temp"),l.u=c,c.i=
c.createElement("base"),c.head.appendChild(c.i),c.h=c.createElement("a"));c.i.href=b;c.h.href=a;return c.h.href||a}},F={async:!0,load:function(a,b,c){if(a)if(a.match(/^data:/)){a=a.split(",");var d=a[1];d=-1<a[0].indexOf(";base64")?atob(d):decodeURIComponent(d);b(d)}else{var f=new XMLHttpRequest;f.open("GET",a,F.async);f.onload=function(){var e=f.responseURL||f.getResponseHeader("Location");e&&0===e.indexOf("/")&&(e=(location.origin||location.protocol+"//"+location.host)+e);var g=f.response||f.responseText;
304===f.status||0===f.status||200<=f.status&&300>f.status?b(g,e):c(g)};f.send()}else c("error: href must be specified")}},y=/Trident/.test(navigator.userAgent),v=/Edge\/\d./i.test(navigator.userAgent);k.prototype.loadImports=function(a){var b=this;a=m(a,"link[rel=import]");h(a,function(c){return b.l(c)})};k.prototype.l=function(a){var b=this,c=a.href;if(void 0!==this.a[c]){var d=this.a[c];d&&d.__loaded&&(a.__import=d,this.j(a))}else this.b++,this.a[c]="pending",F.load(c,function(f,e){f=b.C(f,e||c);
b.a[c]=f;b.b--;b.loadImports(f);b.m()},function(){b.a[c]=null;b.b--;b.m()})};k.prototype.C=function(a,b){var c=this;if(!a)return document.createDocumentFragment();if(y||v)a=a.replace(K,function(e,g,w){return-1===e.indexOf("type=")?g+" type=import-disable "+w:e});var d=document.createElement("template");d.innerHTML=a;if(d.content)a=d.content,E(a);else for(a=document.createDocumentFragment();d.firstChild;)a.appendChild(d.firstChild);if(d=a.querySelector("base"))b=l.c(d.getAttribute("href"),b),d.removeAttribute("href");
d=m(a,'link[rel=import],link[rel=stylesheet][href][type=import-disable],style:not([type]),link[rel=stylesheet][href]:not([type]),script:not([type]),script[type="application/javascript"],script[type="text/javascript"],script[type="module"]');var f=0;h(d,function(e){q(e);l.v(e,b);if("style"===e.localName&&c.o(e)){var g=c.w(e);q(g);e.parentNode.replaceChild(g,e);e=g}e.setAttribute("import-dependency","");if("script"===e.localName&&!e.src&&e.textContent){if("module"===e.type)throw Error("Inline module scripts are not supported in HTML Imports.");
e.setAttribute("src","data:text/javascript;charset=utf-8,"+encodeURIComponent(e.textContent+("\n//# sourceURL="+b+(f?"-"+f:"")+".js\n")));e.textContent="";f++}});return a};k.prototype.o=function(a){return v&&-1<a.textContent.indexOf("@import")};k.prototype.w=function(a){var b=a.ownerDocument.createElement("style");b.textContent=a.textContent;h(a.attributes,function(c){return b.setAttribute(c.name,c.value)});return b};k.prototype.m=function(){var a=this;if(!this.b){this.g.disconnect();this.flatten(document);
var b=!1,c=!1,d=function(){c&&b&&(a.loadImports(document),a.b||(a.g.observe(document.head,{childList:!0,subtree:!0}),a.A()))};this.F(function(){c=!0;d()});this.D(function(){b=!0;d()})}};k.prototype.flatten=function(a){var b=this;a=m(a,"link[rel=import]");h(a,function(c){var d=b.a[c.href];(c.__import=d)&&d.nodeType===Node.DOCUMENT_FRAGMENT_NODE&&(b.a[c.href]=c,c.readyState="loading",c.__import=c,b.flatten(d),c.appendChild(d))})};k.prototype.D=function(a){function b(f){if(f<d){var e=c[f],g=document.createElement("script");
e.removeAttribute("import-dependency");h(e.attributes,function(w){return g.setAttribute(w.name,w.value)});z=g;e.parentNode.replaceChild(g,e);q(g,function(){z=null;b(f+1)})}else a()}var c=m(document,"script[import-dependency]"),d=c.length;b(0)};k.prototype.F=function(a){var b=this,c=m(document,"style[import-dependency],link[rel=stylesheet][import-dependency]"),d=c.length;if(d){var f=(y||v)&&!!document.querySelector("link[rel=stylesheet][href][type=import-disable]");h(c,function(e){f&&b.o(e)&&e.ownerDocument.defaultView!==
window.top&&(e.__loaded=!0);q(e,function(){e.removeAttribute("import-dependency");0===--d&&a()});if(f&&e.parentNode!==document.head){var g=document.createElement(e.localName);g.__appliedElement=e;g.setAttribute("type","import-placeholder");e.parentNode.insertBefore(g,e.nextSibling);for(g=p(e);g&&p(g);)g=p(g);g.parentNode!==document.head&&(g=null);document.head.insertBefore(e,g);e.removeAttribute("type")}})}else a()};k.prototype.A=function(){var a=this,b=m(document,"link[rel=import]");h(b,function(c){return a.j(c)},
!0)};k.prototype.j=function(a){a.__loaded||(a.__loaded=!0,a.import&&(a.import.readyState="complete"),a.dispatchEvent(B(a.import?"load":"error",{bubbles:!1,cancelable:!1,detail:void 0})))};k.prototype.B=function(a){var b=this;h(a,function(c){return h(c.addedNodes,function(d){d&&d.nodeType===Node.ELEMENT_NODE&&(u(d)?b.l(d):b.loadImports(d))})})};var A=null;if(x)n=m(document,"link[rel=import]"),h(n,function(a){a.import&&"loading"===a.import.readyState||(a.__loaded=!0)}),n=function(a){a=a.target;u(a)&&
